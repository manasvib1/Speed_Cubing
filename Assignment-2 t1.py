...
for x in range(2):
    for y in range(2):
        for z in range(2):
            ...
            if x==1: box(pos=pos+vector(0.5, 0, 0), size=vector(0.01, 0.9, 0.9), color=color.red)
            if x==0: box(pos=pos-vector(0.5, 0, 0), size=vector(0.01, 0.9, 0.9), color=color.orange)
            if y==1: box(pos=pos+vector(0,0.5,0), size=vector(0.9, 0.01, 0.9), color=color.blue)
            if y==0: box(pos=pos-vector(0,0.5,0), size=vector(0.9, 0.01, 0.9), color=color.green)
            if z==1: box(pos=pos+vector(0, 0, 0.5), size=vector(0.9, 0.9, 0.01), color=color.white)
